    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-indigo-50 relative">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-20 lg:py-20">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          >
            <motion.img src={thinkletLogo} className="mb-10 w-96 "></motion.img>
            ...
            >
              Join a community of thinkers and writers. Share your insights,
              discover amazing content, and engage with ideas that matter.
            </motion.p>
        ...
        >
          {[
            ...
            },
            {
              icon: "🌐",
              title: "Share Widely",
              desc: "Connect with like-minded readers",
            },
          ].map((feature, i) => (
            <motion.div
              key={i}
