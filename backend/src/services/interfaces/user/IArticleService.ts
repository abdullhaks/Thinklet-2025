...
getArticleResponse(articleId: string, userId?: string): Promise<ArticleResponseDTO>;
...
getArticleService (articleId: string, userId?: string): Promise<ArticleResponseDTO>;
